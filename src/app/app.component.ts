...
export class AppComponent  {
  name = 'Angular';
   ...
   ngOnInit() {
    this.wydatki = [
        new Wydatek('Tankowanie', 252.43, '', new Date(2018, 4, 30),50.5,841),
        ...
        new Wydatek('Tankowanie', 325.20, 'Do pełna po urlopie', new Date(2017, 7, 12),65.555,''),
        new Wydatek('Tankowanie', 325.20, 'Do pełna po urlopie', new Date(2017, 7, 12),'',1300)
    ];
}
}
